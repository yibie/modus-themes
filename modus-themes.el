...
;;;;; tab-bar-mode
    ...
    `(tab-bar-tab ((,c :inherit bold :box (:line-width -2 :color ,bg-tab-current) :background ,bg-tab-current :foreground ,olive :underline (:style line :color ,olive) :overline t)))

...
;;;;; tab-bar-mode
    ...
    `(tab-bar-tab ((,c :inherit bold :box (:line-width -2 :color ,bg-tab-current) :background ,bg-tab-current :foreground ,olive :underline (:style line :color ,olive))))
...
;;;;; telega
    ...
    `(telega-msg-inline-reply ((,c :background ,bg-main :foreground ,indigo)))
    ...
    `(telega-muted-count ((,c :inherit bold :foreground ,indigo)))

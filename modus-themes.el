...
;;;;; tab-bar-mode
    ...
    `(tab-bar-tab ((,c :inherit bold :box (:line-width -2 :color ,bg-tab-current) :background ,bg-tab-current :foreground ,green)))
...
;;;;; telega
    ...
    `(telega-msg-self-title ((,c :inherit (bold italic) :foreground ,orange :italic t)))
    `(telega-msg-user-title ((,c :inherit italic)))
    `(telega-msg-inline-reply ((,c :background ,bg-main :foreground ,green-faint)))
    ...
    `(telega-unmuted-count ((,c :foreground ,red-intense)))
    `(telega-mention-count ((,c :inherit bold :foreground ,orange)))

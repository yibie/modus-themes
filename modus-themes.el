...
;;;;; org
    ...
    `(org-block-begin-line ((,c ,@(modus-themes--org-block prose-block bg-active))))
...
;;;;; tab-bar-mode
    ...
    `(tab-bar-tab-group-current ((,c :inherit bold :background ,bg-tab-current :box '(:line-width (0 . -1) :color ,bg-tab-current) :foreground ,fg-alt)))
    `(tab-bar-tab-group-inactive ((,c :background ,bg-tab-bar :box '(:line-width (0 . -1) :color ,bg-tab-bar) :foreground ,fg-alt)))
    `(tab-bar-tab ((,c :inherit bold :box '(:line-width (0 . -1) :color ,green :style nil) :background ,bg-tab-current :foreground ,green-cooler)))
    `(tab-bar-tab-inactive ((,c :box '(:line-width (0 . -1) :color ,bg-tab-other) :background ,bg-tab-other)))
